...
// Leaderboard Student interface to match the backend response
...
export const gamificationService = {
  ...
  async getGlobalLeaderboard(params?: { limit?: number }): Promise<ApiResponse<LeaderboardStudent[]>> {
    try {
      const response = await apiClient.get('/gamification/leaderboard/all', { params });
      return {
        success: true,
  ...
  async getAllStudentsLeaderboard(params?: { limit?: number }): Promise<ApiResponse<LeaderboardStudent[]>> {
    try {
      const response = await apiClient.get('/gamification/leaderboard/all', { params });
      return {
        success: true,
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengambil leaderboard seluruh siswa'
      };
    }
  },
  ...
  async getBadges(): Promise<ApiResponse<unknown[]>> {
    try {
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengambil data badge'
      };
    }
  },

  async getChallenges(): Promise<ApiResponse<unknown[]>> {
    try {
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengambil data challenge'
      };
    }
  },

  async createBadge(badgeData: { name: string; description: string; icon?: string; xpReward?: number | null; criteria?: string }): Promise<ApiResponse<unknown>> {
    try {
      const response = await apiClient.post('/gamification/badges', badgeData);
      return {
        success: true,
        data: response.data.data,
        message: response.data.message
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal membuat badge'
      };
    }
  },

  async updateBadge(id: string, badgeData: { name: string; description: string; icon?: string; xpReward?: number | null }): Promise<ApiResponse<unknown>> {
    try {
      const response = await apiClient.put(`/gamification/badges/${id}`, badgeData);
      return {
        success: true,
        data: response.data.data,
        message: response.data.message
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal memperbarui badge'
      };
    }
  },
  ...
  async deleteBadge(id: string): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal menghapus badge'
      };
    }
  },

  async createChallenge(challengeData: { title: string; description: string; duration?: string | number; targetType?: string; specificClass?: string; xpReward?: number | null }): Promise<ApiResponse<unknown>> {
    try {
      const response = await apiClient.post('/gamification/challenges', challengeData);
      return {
        success: true,
        data: response.data.data,
        message: response.data.message
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal membuat challenge'
      };
    }
  },

  // Enhanced Challenge Management Functions
  async getChallengeParticipants(challengeId: string): Promise<ApiResponse<any[]>> {
    try {
      const response = await apiClient.get(`/gamification/challenges/${challengeId}/participants`);
      return {
        success: true,
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengambil data peserta challenge'
      };
    }
  },

  async markChallengeCompleted(participantId: string): Promise<ApiResponse<any>> {
    try {
      const response = await apiClient.patch(`/gamification/challenges/participants/${participantId}/complete`);
      return {
        success: true,
        data: response.data.data
      };
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal menandai challenge sebagai selesai'
      };
    }
  },
  ...
  async deleteChallenge(challengeId: string): Promise<ApiResponse<any>> {
    try {
      const response = await apiClient.delete(`/gamification/challenges/${challengeId}`);
      return {
        success: true,
        data: response.data.data
      };
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal menghapus challenge'
      };
    }
  },

  async updateChallenge(challengeId: string, challengeData: any): Promise<ApiResponse<any>> {
    try {
      const response = await apiClient.patch(`/gamification/challenges/${challengeId}`, challengeData);
      return {
        success: true,
        data: response.data.data
      };
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengupdate challenge'
      };
    }
  },
  ...
  async getStudentChallenges(studentId: string): Promise<ApiResponse<unknown[]>> {
    try {
      ...
      return {
        success: false,
        error: getErrorMessage(error) || 'Gagal mengambil data challenge siswa'
      };
    }
  },
};
